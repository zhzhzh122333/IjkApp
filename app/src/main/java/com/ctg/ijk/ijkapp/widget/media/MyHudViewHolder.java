package com.ctg.ijk.ijkapp.widget.media;
...
public class MyHudViewHolder {
    private TableLayoutBinder mTableLayoutBinder;
    private HashMap<Integer, View> mRowMap = new HashMap<Integer, View>();
    private IMediaPlayer mMediaPlayer;

    private Context mContext;
    public ViewGroup mLinearView;
    public LinearLayout mLinearLayout;

    public MyHudViewHolder(Context context, int  layoutResourceId) {
        mContext = context;
        mLinearView = (ViewGroup) LayoutInflater.from(mContext).inflate(layoutResourceId, null);
        mLinearLayout = (LinearLayout) mLinearView.findViewById(R.id.table);
    }

    public MyHudViewHolder(Context context, LinearLayout linearLayout) {
        mContext = context;
        mLinearView = linearLayout;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    MyHudViewHolder holder = MyHudViewHolder.this;
